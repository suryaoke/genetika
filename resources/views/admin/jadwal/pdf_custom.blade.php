...
<body>
    ...
    <h2 style="text-align: center; margin-bottom: 11px; font-family: Calibri, sans-serif;">JADWAL MATA PELAJARAN
        SEMESTER {{ strtoupper($semester) }}</h2>

    <h3 style="text-align: center; margin-bottom: 11px; font-family: Calibri, sans-serif;">SMK MUHAMMADIYAH 1
        PEKANBARU
    </h3>
