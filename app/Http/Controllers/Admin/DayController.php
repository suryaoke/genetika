...
class DayController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $notification = [
            'message' => 'Hari Create Successfully',
            'alert-type' => 'success'
        ];

        return redirect()->route('admin.days')->with($notification);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $days->save();
        $notification = [
            'message' => 'Hari Update Successfully',
            'alert-type' => 'success'
        ];
    ...
    public function destroy($id)
    {
        ...
        $notification = [
            'message' => 'Hari Delete Successfully',
            'alert-type' => 'success'
        ];

        return redirect()->route('admin.days')->with('success', 'Hari berhasil dihapus')->with($notification);
    }
}
